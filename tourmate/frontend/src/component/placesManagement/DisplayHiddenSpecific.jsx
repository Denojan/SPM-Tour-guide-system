...
function DisplayHiddenSpecific() {
    ...
    async function fetchFavoritePlaces() {
      ...
      try {
        ...
        const response = await axios.get(
          `http://localhost:8080/favplace/gethiddenspecific/${userId}`,config
        );
      ...
      <div>
        ...
        const config = {
          ...
          withCredentials: true,
              ...
              axios
                .delete(`http://localhost:8080/favplace/deleteplace/${placeId}`,config)
                .then((res) => {
  ...
  const handleTextSearch = (e) => {
    ...
    axios
      .get(`http://localhost:8080/favplace/gethiddenspecific/${userId}`,config)
      .then((res) => {
        if (res.data.place) {
