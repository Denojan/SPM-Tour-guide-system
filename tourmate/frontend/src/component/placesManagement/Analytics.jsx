  ...
  return (
    <div className="mx-8 my-12 ">
      ...
      <div className="flex space-x-4 mb-4">
        <div className="w-1/3 p-4 bg-gray-100 shadow-md rounded flex items-center justify-center">
          <div className="flex items-center">
            <img className="w-20 mr-2" src={hiddenlogo} alt="Hidden Places" />
            <div>
              <p className="text-3xl font-semibold text-center text-gray-800">
                {placeCount.HiddenPlace ?? 0}
              </p>
              <p className="text-lg text-center text-gray-500">Hidden Places</p>
            </div>
          </div>
        </div>
      ...
      <div className="flex justify-center">
        <div className="relative overflow-x-auto shadow-md rounded-lg p-4 w-1/2 ">
